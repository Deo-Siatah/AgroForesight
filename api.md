...
Risk assessment endpoints calculate the agricultural risk score for a loan by analyzing:
...
1. Raw risk assessment scores generated by the Risk Engine.
2. AI Analyst interpretation explaining the score in natural language for:
   - Farmers
   - SACCO officers
   - Extension officers
...
The Risk Analyst layer uses Google's Gemini LLM.

Before running AI features:
...
## Endpoint
Require admin role
## POST /api/v1/risks-assessments?loan_id=<loan_uuid>

Example
POST /api/v1/risks-assessments?loan_id=0376042a-c9f8-4ba2-94aa-7fbbb801028f

## example response
```
{
  "risk_assessment": {
    "id": "a4d58347-b725-4bdf-887d-86f3ea40f998",
    ...
    "created_at": "2026-06-23T07:48:14.626956"
  },
  ...
  "analysis": {
    ...
    "summary": 
    "The farm currently has a medium risk level with a score of 60 out of 100.",


    "explanation":

    "The main contributor is weather risk with a score of 25. Harvest risk contributes 20 points because the farm is approaching the expected harvest period and requires preparation.",


    "recommendation":

    "The SACCO should contact the farmer and provide support on harvest preparation and weather monitoring.",


    "key_drivers": [

      "Weather risk contributed 25 points",

      "Harvest timeline contributed 20 points",

      "Financial risk remains low at 5 points"
...
GET /api/v1/risks-assessments

# Get assesment by id
GET /api/v1/risks-assessments/{assessment_id}

# Recalculate loan risk
POST /api/v1/loans/{loan_id}/risk/recalculate


## Recommendation apis

# Generate AI recommendation for farmer 
POST /api/v1/recommendations/generate/{season_id}

admin auth required

# Get saved recommendations for entire season
GET /api/v1/recommendations/season/{season_id}
